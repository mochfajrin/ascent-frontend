const LoadingSkeleton = () => {
  return (
    ...
    //       </div>
    //     </div>
    //     <div className="flex flex-row items-center space-x-5 md:space-x-3  xl:space-x-6 bg-gray-300  p-6 md:p-3 w-5/6 lg:w-4/6  xl:w-3/5 lg:p-4  xl:p-6  rounded-xl">
    //       <div className="p-2 bg-white rounded-3xl md:rounded-2xl">
    //         <svg
    //           className="w-10 h-10 text-gray-200 dark:text-gray-600"
    //           aria-hidden="true"
    ...
    //   <p className="text-xl font-bold md:text-2xl mt-40 ">
    ...
    //         <div className="w-44 h-7 bg-gray-200"></div>
    //         <div className="w-44 h-7 bg-gray-200"></div>
    //       </div>
    //     </div>

    //     <div className="w-full h-80 mt-3 bg-gray-200 text-gray-500 rtl:text-right"></div>
    //   </div>
