...
const FormAddCourse = ({ setImageFile }) => {
    ...
    <div className="flex flex-row justify-between space-x-16  text-base">
      <form className="w-full">
        <div className="mb-5">
          ...
          >
            Kode kelas : <span className="text-red-600 font-bold">*</span>
          </label>
          <input
            onChange={(e) =>
        ...
        <div className="mb-5">
          <label
            ...
            className="block mb-2 text-[#0092A4] font-semibold"
          >
            Nama kelas : <span className="text-red-600 font-bold">*</span>
          </label>
          <input
            onChange={(e) =>
        ...
        <div className="mb-5">
          <label
            ...
            className="block mb-2 text-[#0092A4] font-semibold"
          >
            Level kelas : <span className="text-red-600 font-bold">*</span>
          </label>
          <select
            onChange={(e) =>
        ...
        <div className="mb-5">
          <label
            ...
            className="block mb-2  text-[#0092A4] font-semibold"
          >
            Tentang kelas : <span className="text-red-600 font-bold">*</span>
          </label>
          <textarea
            onChange={(e) =>
        ...
        <div className="mb-5">
          <label
            ...
            className="block mb-2  text-[#0092A4] font-semibold"
          >
            Grub kelas : <span className="text-red-600 font-bold">*</span>
          </label>
          <input
            onChange={(e) =>
      ...
      <form className="w-full">
        ...
        <div className="mb-5">
          <label
            ...
            className="block mb-2 text-[#0092A4] font-semibold"
          >
            Kategori kelas : <span className="text-red-600 font-bold">*</span>
          </label>
          <select
            onChange={(e) =>
              dispatch(
        ...
        <div className="mb-5">
          <label
            ...
            className="block mb-2  text-[#0092A4] font-semibold"
          >
            Beri rating : <span className="text-red-600 font-bold">*</span>
          </label>
          <input
            onChange={(e) =>
              dispatch(
